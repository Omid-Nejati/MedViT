...
Please go to ["Colab_MedViT.ipynb"](https://github.com/Omid-Nejati/MedViT/blob/main/MedViT.py) for complete detail on dataset preparation and Train/Test procedure or follow the instructions below. [![Open In Colab](https://colab.research.google.com/drive/1k3oHisztINVHZaqYcWBnkFTwyImLlkDm?usp=sharing)
