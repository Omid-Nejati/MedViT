...
- (beginner friendly🍉) To train/evaluate MedViT on Cifar/Imagenet/CustomDataset fllow ["CustomDataset"](https://github.com/Omid-Nejati/MedViT/blob/main/CustomDataset.md). 
